package com.zhaoxiuyuan.aidlclient;

import com.zhaoxiuyuan.aidltest.Person;
import com.zhaoxiuyuan.aidltest.ITestAidl;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        service.setAction("android.intent.action.MyIntentService");
        service.setPackage("com.zhaoxiuyuan.aidltest");
